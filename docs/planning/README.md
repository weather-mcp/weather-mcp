...
| Forecast uncertainty/confidence | ✅ | FE §13.1 — **fully covered as of v1.22.0.** The *across*-model half shipped for v1.21.0 as `compare_models` ([`docs/plans/multi-model-comparison-plan.md`](../plans/multi-model-comparison-plan.md)): cross-model agreement bands, spreads, and per-day Good/Moderate/Low labels. The *within*-model half shipped for v1.22.0 as `ensemble_spread` ([`docs/plans/ensemble-spread-plan.md`](../plans/ensemble-spread-plan.md)): ECMWF ENS member distribution, interquartile bands, wet-member fractions, and per-day High/Moderate/Low confidence |
...
| Single-model ensemble spread (`ensemble_spread`, ECMWF ENS) — closes FE §13.1 | ✅ v1.22.0 |

...
- **Version:** 1.20.0 — global wildfire detection (NASA FIRMS) and global fire weather (computed Fosberg index), plus the pre-release review hardening. (The v1.15–v1.17 content further below was developed against internal version targets and first shipped in the v1.18.0 consolidated release.)
...
**Last Updated:** 2026-08-14 (v1.20.0)

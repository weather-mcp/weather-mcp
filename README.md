...
[![Tests](https://img.shields.io/badge/tests-1%2C338%20passing-brightgreen)](./docs/testing/TEST_SUITE_README.md)
...
- **Fully open source** — MIT licensed, readable TypeScript, 1,338 tests. Audit it, fork it, fix it.
...
npm test               # Run all 1,338 tests (~2 seconds)
